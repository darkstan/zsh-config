...
source $ZSH/custom/themes/antigen.zsh
...
SPACESHIP_PACKAGE_SYMBOL="Package"
...
SPACESHIP_ELIXIR_SYMBOL="Eltxir"
...
SPACESHIP_JULIA_PREFIX="$SPACESHIP_PROMPT_DEFAULT_PREFIXunalias z
j() {
     if [[ -z "$*" ]]; then
